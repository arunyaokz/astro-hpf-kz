...
export const TRANSLATIONS = {
  ...
  ru: {
    ...
    kurekGreen: "Зеленый канал Курык",
    customsClearance: "Таможенное оформление",
    warehousing: "Складирование и дистрибуция",
    transport: "Мультимодальные перевозки",
    lastMile: "Доставка последней мили",
    financial: "Финансовые услуги",
    
    // Solutions
    solutionsTitle: "Отраслевые решения",
    manufacturing: "Производство", 
    mining: "Добыча и энергетика",
    automotive: "Автомобили и запчасти",
    ecommerce: "Трансграничная электронная коммерция",
    retail: "Товары повседневного спроса и розничная торговля",
    
    // KPIs
    ontimeDelivery: "Доставка в срок",
    intactRate: "Сохранность груза", 
    responseTime: "Время отклика",
    satisfaction: "Удовлетворенность клиентов",
    
    // About
    aboutTitle: "О нас",
    mission: "Создавать долгосрочную ценность для клиентов через системную определенность",
    vision: "Стать самой надежной комплексной логистической платформой Транскаспийского Среднего коридора",
...
// KPI Data for Animation
export const KPI_DATA = {
  ontimeDelivery: { value: 98.5, unit: "%" },
  intactRate: { value: 99.2, unit: "%" }, 
